...
Fork [this repository](https://github.com/nebiros88/js-spring-2026-node-basics)

The repository contains several nested folders inside `src`. Your task is to implement necessary functionality inside them
...
- `env.js` - implement function that parses environment variables with prefix `TEST_` and prints them to the console in the format `TEST_name1=value1; TEST_name2=value2`
